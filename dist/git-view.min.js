class e extends HTMLElement{constructor(){super()}connectedCallback(){}}class t extends HTMLElement{constructor(){super()}connectedCallback(){this.render()}render(){const e=document.createElement("div");e.className="folder",e.innerHTML=`<img class="folder-icon" src="../assets/folder.svg"/>\n    <div class="folder-name">${this.getAttribute("name")}</div>`,this.prepend(e)}}
/**
 * @license
 ...
 */const n=new WeakMap,i=e=>"function"==typeof e&&n.has(e),s="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,r=(e,t,n=null)=>{for(;t!==n;){const n=t.nextSibling;e.removeChild(t),t=n}},o={},a={},l=`{{lit-${String(Math.random()).slice(2)}}}`,c=`\x3c!--${l}--\x3e`,h=new RegExp(`${l}|${c}`);class d{constructor(e,t){this.parts=[],this.element=t;const n=[],i=[],s=document.createTreeWalker(t.content,133,null,!1);let r=0,o=-1,a=0;const{strings:c,values:{length:d}}=e;for(;a<d;){const e=s.nextNode();if(null!==e){if(o++,1===e.nodeType){if(e.hasAttributes()){const t=e.attributes,{length:n}=t;let i=0;for(let e=0;e<n;e++)g(t[e].name,"$lit$")&&i++;for(;i-- >0;){const t=c[a],n=m.exec(t)[2],i=n.toLowerCase()+"$lit$",s=e.getAttribute(i);e.removeAttribute(i);const r=s.split(h);this.parts.push({type:"attribute",index:o,name:n,strings:r}),a+=r.length-1}}"TEMPLATE"===e.tagName&&(i.push(e),s.currentNode=e.content)}else if(3===e.nodeType){const t=e.data;if(t.indexOf(l)>=0){const i=e.parentNode,s=t.split(h),r=s.length-1;for(let t=0;t<r;t++){let n,r=s[t];if(""===r)n=u();else{const e=m.exec(r);null!==e&&g(e[2],"$lit$")&&(r=r.slice(0,e.index)+e[1]+e[2].slice(0,-"$lit$".length)+e[3]),n=document.createTextNode(r)}i.insertBefore(n,e),this.parts.push({type:"node",index:++o})}""===s[r]?(i.insertBefore(u(),e),n.push(e)):e.data=s[r],a+=r}}else if(8===e.nodeType)if(e.data===l){const t=e.parentNode;null!==e.previousSibling&&o!==r||(o++,t.insertBefore(u(),e)),r=o,this.parts.push({type:"node",index:o}),null===e.nextSibling?e.data="":(n.push(e),o--),a++}else{let t=-1;for(;-1!==(t=e.data.indexOf(l,t+1));)this.parts.push({type:"node",index:-1}),a++}}else s.currentNode=i.pop()}for(const e of n)e.parentNode.removeChild(e)}}const g=(e,t)=>{const n=e.length-t.length;return n>=0&&e.slice(n)===t},p=e=>-1!==e.index,u=()=>document.createComment(""),m=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const v=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:e=>e}),f=` ${l} `;class y{constructor(e,t,n,i){this.strings=e,this.values=t,this.type=n,this.processor=i}getHTML(){const e=this.strings.length-1;let t="",n=!1;for(let i=0;i<e;i++){const e=this.strings[i],s=e.lastIndexOf("\x3c!--");n=(s>-1||n)&&-1===e.indexOf("--\x3e",s+1);const r=m.exec(e);t+=null===r?e+(n?f:c):e.substr(0,r.index)+r[1]+r[2]+"$lit$"+r[3]+l}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");let t=this.getHTML();return void 0!==v&&(t=v.createHTML(t)),e.innerHTML=t,e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const w=e=>null===e||!("object"==typeof e||"function"==typeof e),x=e=>Array.isArray(e)||!(!e||!e[Symbol.iterator]);class k{constructor(e,t,n){this.dirty=!0,this.element=e,this.name=t,this.strings=n,this.parts=[];for(let e=0;e<n.length-1;e++)this.parts[e]=this._createPart()}_createPart(){return new _(this)}_getValue(){const e=this.strings,t=e.length-1,n=this.parts;if(1===t&&""===e[0]&&""===e[1]){const e=n[0].value;if("symbol"==typeof e)return String(e);if("string"==typeof e||!x(e))return e}let i="";for(let s=0;s<t;s++){i+=e[s];const t=n[s];if(void 0!==t){const e=t.value;if(w(e)||!x(e))i+="string"==typeof e?e:String(e);else for(const t of e)i+="string"==typeof t?t:String(t)}}return i+=e[t],i}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class _{constructor(e){this.value=void 0,this.committer=e}setValue(e){e===o||w(e)&&e===this.value||(this.value=e,i(e)||(this.committer.dirty=!0))}commit(){for(;i(this.value);){const e=this.value;this.value=o,e(this)}this.value!==o&&this.committer.commit()}}class E{constructor(e){this.value=void 0,this.__pendingValue=void 0,this.options=e}appendInto(e){this.startNode=e.appendChild(u()),this.endNode=e.appendChild(u())}insertAfterNode(e){this.startNode=e,this.endNode=e.nextSibling}appendIntoPart(e){e.__insert(this.startNode=u()),e.__insert(this.endNode=u())}insertAfterPart(e){e.__insert(this.startNode=u()),this.endNode=e.endNode,e.endNode=this.startNode}setValue(e){this.__pendingValue=e}commit(){if(null===this.startNode.parentNode)return;for(;i(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=o,e(this)}const e=this.__pendingValue;e!==o&&(w(e)?e!==this.value&&this.__commitText(e):e instanceof y?this.__commitTemplateResult(e):e instanceof Node?this.__commitNode(e):x(e)?this.__commitIterable(e):e===a?(this.value=a,this.clear()):this.__commitText(e))}__insert(e){this.endNode.parentNode.insertBefore(e,this.endNode)}__commitNode(e){this.value!==e&&(this.clear(),this.__insert(e),this.value=e)}__commitText(e){const t=this.startNode.nextSibling,n="string"==typeof(e=null==e?"":e)?e:String(e);t===this.endNode.previousSibling&&3===t.nodeType?t.data=n:this.__commitNode(document.createTextNode(n)),this.value=e}__commitTemplateResult(e){const t=this.options.templateFactory(e);if(this.value instanceof b&&this.value.template===t)this.value.update(e.values);else{const n=new b(t,e.processor,this.options),i=n._clone();n.update(e.values),this.__commitNode(i),this.value=n}}__commitIterable(e){Array.isArray(this.value)||(this.value=[],this.clear());const t=this.value;let n,i=0;for(const s of e)n=t[i],void 0===n&&(n=new E(this.options),t.push(n),0===i?n.appendIntoPart(this):n.insertAfterPart(t[i-1])),n.setValue(s),n.commit(),i++;i<t.length&&(t.length=i,this.clear(n&&n.endNode))}clear(e=this.startNode){r(this.startNode.parentNode,e.nextSibling,this.endNode)}}class A{constructor(e,t,n){if(this.value=void 0,this.__pendingValue=void 0,2!==n.length||""!==n[0]||""!==n[1])throw new Error("Boolean attributes can only contain a single expression");this.element=e,this.name=t,this.strings=n}setValue(e){this.__pendingValue=e}commit(){for(;i(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=o,e(this)}if(this.__pendingValue===o)return;const e=!!this.__pendingValue;this.value!==e&&(e?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=e),this.__pendingValue=o}}class S extends k{constructor(e,t,n){super(e,t,n),this.single=2===n.length&&""===n[0]&&""===n[1]}_createPart(){return new N(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class N extends _{}let C=!1;(()=>{try{const e={get capture(){return C=!0,!1}};window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch(e){}})();class ${constructor(e,t,n){this.value=void 0,this.__pendingValue=void 0,this.element=e,this.eventName=t,this.eventContext=n,this.__boundHandleEvent=e=>this.handleEvent(e)}setValue(e){this.__pendingValue=e}commit(){for(;i(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=o,e(this)}if(this.__pendingValue===o)return;const e=this.__pendingValue,t=this.value,n=null==e||null!=t&&(e.capture!==t.capture||e.once!==t.once||e.passive!==t.passive),s=null!=e&&(null==t||n);n&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),s&&(this.__options=L(e),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=e,this.__pendingValue=o}handleEvent(e){"function"==typeof this.value?this.value.call(this.eventContext||this.element,e):this.value.handleEvent(e)}}const L=e=>e&&(C?{capture:e.capture,passive:e.passive,once:e.once}:e.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const F=new class{handleAttributeExpressions(e,t,n,i){const s=t[0];if("."===s){return new S(e,t.slice(1),n).parts}if("@"===s)return[new $(e,t.slice(1),i.eventContext)];if("?"===s)return[new A(e,t.slice(1),n)];return new k(e,t,n).parts}handleTextExpression(e){return new E(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const V=(e,...t)=>new y(e,t,"html",F);var P=V`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="122.881px" height="122.88px" viewBox="0 0 122.881 122.88" enable-background="new 0 0 122.881 122.88" xml:space="preserve"><g><path d="M61.44,0c16.966,0,32.326,6.877,43.445,17.996c11.119,11.118,17.996,26.479,17.996,43.444 c0,16.967-6.877,32.326-17.996,43.444C93.766,116.003,78.406,122.88,61.44,122.88c-16.966,0-32.326-6.877-43.444-17.996 C6.877,93.766,0,78.406,0,61.439c0-16.965,6.877-32.326,17.996-43.444C29.114,6.877,44.474,0,61.44,0L61.44,0z M80.16,37.369 c1.301-1.302,3.412-1.302,4.713,0c1.301,1.301,1.301,3.411,0,4.713L65.512,61.444l19.361,19.362c1.301,1.301,1.301,3.411,0,4.713 c-1.301,1.301-3.412,1.301-4.713,0L60.798,66.157L41.436,85.52c-1.301,1.301-3.412,1.301-4.713,0c-1.301-1.302-1.301-3.412,0-4.713 l19.363-19.362L36.723,42.082c-1.301-1.302-1.301-3.412,0-4.713c1.301-1.302,3.412-1.302,4.713,0l19.363,19.362L80.16,37.369 L80.16,37.369z M100.172,22.708C90.26,12.796,76.566,6.666,61.44,6.666c-15.126,0-28.819,6.13-38.731,16.042 C12.797,32.62,6.666,46.314,6.666,61.439c0,15.126,6.131,28.82,16.042,38.732c9.912,9.911,23.605,16.042,38.731,16.042 c15.126,0,28.82-6.131,38.732-16.042c9.912-9.912,16.043-23.606,16.043-38.732C116.215,46.314,110.084,32.62,100.172,22.708 L100.172,22.708z"></path></g></svg>`,H=V`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 98.15" style="enable-background:new 0 0 122.88 98.15" xml:space="preserve"><style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path class="st0" d="M6.02,0h33.66L50.8,12.3h66.46c3.1,0,5.63,2.55,5.63,5.63V92.5c0,3.1-2.53,5.64-5.63,5.64l-110.59,0 C3.56,98.15,0,95.6,0,92.5V6.02C0,2.72,2.72,0,6.02,0L6.02,0z M111.83,27.42c0-2.98-2.46-5.42-5.43-5.42H17.46 c-2.96,0-6.41,2.44-6.41,5.42v53.8c0,3,3.45,5.43,6.41,5.43h88.95c2.97,0,5.43-2.44,5.43-5.43V27.42L111.83,27.42z"></path></g></svg>`,I=V`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="64" height="64" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 640 640"><path d="M319.988 7.973C143.293 7.973 0 151.242 0 327.96c0 141.392 91.678 261.298 218.826 303.63 16.004 2.964 21.886-6.957 21.886-15.414 0-7.63-.319-32.835-.449-59.552-89.032 19.359-107.8-37.772-107.8-37.772-14.552-36.993-35.529-46.831-35.529-46.831-29.032-19.879 2.209-19.442 2.209-19.442 32.126 2.245 49.04 32.954 49.04 32.954 28.56 48.922 74.883 34.76 93.131 26.598 2.882-20.681 11.15-34.807 20.315-42.803-71.08-8.067-145.797-35.516-145.797-158.14 0-34.926 12.52-63.485 32.965-85.88-3.33-8.078-14.291-40.606 3.083-84.674 0 0 26.87-8.61 88.029 32.8 25.512-7.075 52.878-10.642 80.056-10.76 27.2.118 54.614 3.673 80.162 10.76 61.076-41.386 87.922-32.8 87.922-32.8 17.398 44.08 6.485 76.631 3.154 84.675 20.516 22.394 32.93 50.953 32.93 85.879 0 122.907-74.883 149.93-146.117 157.856 11.481 9.921 21.733 29.398 21.733 59.233 0 42.792-.366 77.28-.366 87.804 0 8.516 5.764 18.473 21.992 15.354 127.076-42.354 218.637-162.274 218.637-303.582 0-176.695-143.269-319.988-320-319.988l-.023.107z"></path></svg>`;const O=V`
  <style>
    *{
  ...
  <div class="container">
    <section class="gv-top"><div class="folder-icon">${H}</div>Files</section>
    <section class="gv-directory"></section>
  </div>
`;class q extends HTMLElement{constructor(){super(),this.root=this.attachShadow({mode:"open"})}set tree(e){this._tree=e,this.render()}get tree(){return this._tree}render(){M(O,this.root);const e=new Map;this.tree.forEach((t=>{let n=this.shadowRoot.querySelector(".gv-directory");if(t.path.includes("/")){let i="";t.path.split("/").slice(0,-1).forEach((t=>{if(e.has(i+"/"+t))i=i+"/"+t,n=e.get(i);else{const s=document.createElement("gv-directory-folder");s.setAttribute("name",t),n.appendChild(s),n=s,i+="/"+t,e.set(i,s)}}))}if("blob"===t.type){const e=document.createElement("gv-directory-item");e.setAttribute("data-path",t.path),e.innerHTML=t.path.split("/").pop(),n.appendChild(e)}}))}}customElements.define("gv-directory-folder",t),customElements.define("gv-directory-item",e);const B=V`
  <style>
  * {
    box-sizing: border-box;
  }
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");class R extends HTMLElement{constructor(){super(),this.root=this.attachShadow({mode:"open"}),this.current,this.tabs=new Set}static get observedAttributes(){return["current"]}attributeChangedCallback(){this.render()}connectedCallback(){const e=V`
    <style>
    * {
      box-sizing: border-box;
    }
...
`;class X extends HTMLElement{constructor(){super(),this.root=this.attachShadow({mode:"open"}),M(G,this.root),this.preElement=this.root.querySelector("pre"),this.tabsElement=this.root.querySelector("gv-tabs"),this.imgContainer=this.root.querySelector("#image-container"),this.cache=null,this.tabsElement.addEventListener("active",(e=>{this.loadViewer(this.cache.get(e.detail.tab),e.detail.tab)})),this.tabsElement.addEventListener("close",(e=>{this.loadViewer(this.cache.get(e.detail.next),e.detail.next)})),this.root.querySelector(".preview").addEventListener("click",(e=>{this.dispatchEvent(new CustomEvent("show-preview"))}),!0)}static get observedAttributes(){return["data-path"]}attributeChangedCallback(){this.render(),this.tabsElement.updateActive(this.getAttribute("data-path"))}render(){M(G,this.root);const e=this.getAttribute("data-path");this.loadViewer(this.cache.get(e),e)}loadViewer(e,t){var n;if(this.preElement.innerHTML="",this.imgContainer.innerHTML="",this.imgContainer.className="hidden",t)if(n=t,["png","gif","jpg","jpeg","svg","webp"].some((e=>n.indexOf(e)>-1))){const e=document.createElement("iframe"),n=`<!DOCTYPE html>\n        <html>\n        <head>\n          <style>\n            html,body {\n              margin:0;\n              padding:0;\n              height:100%;\n              width:100%;\n            }\n            body {\n              display: flex;\n              justify-content: center;\n              align-items: center;\n            }\n          </style>\n        <base href="${this.getAttribute("gist-url")}"/></head>\n          <body>\n            <img style="width: 50%;" src="${t}"/>\n          </body>\n        </html>`;e.src="data:text/html;base64,"+encodeURIComponent(btoa(n)),this.imgContainer.className="",this.imgContainer.appendChild(e)}else if(t){const n=document.createElement("code"),{fn:i,ext:s}=function(e){const t=e.split(".").pop();return D.languages[t]?{fn:D.languages[t],ext:t}:{fn:D.languages.markup,ext:"markup"}}(t),r=D.highlight(e,i,s);n.innerHTML=r.split("\n").map(((e,t)=>`<span class="line-num">${(t+1).toString().padStart(2," ")}.</span> ${e}`)).join("\n"),this.preElement.appendChild(n),this.root.querySelector("#placeholder").classList="hidden"}else this.root.querySelector("#placeholder").classList="";else this.root.querySelector("#placeholder").classList=""}}customElements.define("gv-tabs",R);var J=V`
<style>
  * {
    box-sizing: border-box;
